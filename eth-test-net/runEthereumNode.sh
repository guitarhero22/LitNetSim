...
geth --datadir data/ --rpc --rpcport=1558 --rpcapi "eth,net,web3,debug,rpcapi, personal,miner" --networkid=2310 --port=1547 --syncmode full --gcmode archive --nodiscover --nodekey=nk.txt --verbosity 5 --allow-insecure-unlock --unlock 0x8bF1384286f068058c41e136EB25451F95158722 --password password.txt